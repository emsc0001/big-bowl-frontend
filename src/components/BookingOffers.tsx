...
export const BookingOffers = () => {
    ...
    const handleAddProduct = (product: Product) => {
        setAddedProducts([...addedProducts, product]); // Add the product to the addedProducts array
    ...
    const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        navigate("/booking/finalise", { state: { bookingActivity, dinnerBookingActivity, addedProducts } });
    };
